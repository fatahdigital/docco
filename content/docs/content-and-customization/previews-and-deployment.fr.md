...
* You have completed the [Getting Started](/fr/docs/getting-started/) or have a Hugo website you are ready to deploy and share with the world.
...
* You have authenticated.
  ...
  * Azure: [Install the CLI](https://docs.microsoft.com/fr-us/cli/azure/install-azure-cli) and run [`az login`](https://docs.microsoft.com/fr-us/cli/azure/authenticate-azure-cli).
...
3. You have a ready-to-publish Hugo website or have at least completed the [Getting Started](/fr/getting-started).
